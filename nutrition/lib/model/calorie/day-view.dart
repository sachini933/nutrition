...
import 'package:nutrition/model/calorie/calorie-stats.dart';
import 'package:nutrition/model/calorie/constants.dart';
import 'package:nutrition/model/calorie/database.dart';
import 'package:nutrition/model/calorie/food-track-task.dart';

import 'package:nutrition/model/calorie/theme_colors.dart';
      ...
      builder: (BuildContext context, Widget? child) {
        return Theme(
          data: ThemeData.light().copyWith(
            primaryColor: Color.fromARGB(255, 37, 48, 36), //Head background
          ),
          child: child!,
        );
      },
